...
optimization_result grid_search_optimize(
    ...
    std::cout << "  Range: [" << var.min_feasible << ", " << var.max_feasible << "]" << std::endl;
    ...
    for (int i = 0; i < num_samples_per_var; ++i) {
        ...
        std::cout << "  Max Displacement: " << fea_res.max_displacement << " m" << std::endl;
        std::cout << "  Max Stress: " << fea_res.max_stress / 1e6f << " MPa" << std::endl;
...
optimization_result optimize(
    ...
    if (result.success) {
        ...
        std::cout << "Optimal Objective: " << result.optimal_objective / 1e6f << " MPa" << std::endl;
